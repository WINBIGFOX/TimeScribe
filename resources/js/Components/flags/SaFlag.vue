<template>
    <svg id="flag-icons-sa" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <clipPath id="sa-a">
                <path d="M-85.3 0h682.6v512H-85.3z" fill-opacity=".7" />
            </clipPath>
        </defs>
        <g clip-path="url(#sa-a)" fill-rule="evenodd" transform="translate(80)scale(.9375)">
            <path d="M-128 0h768v512h-768z" fill="#165d31" />
            <path
                ...
                fill="#fff"
            />
            <path d="m99 194.2-32 15.4c.3-7.3 15.1-20.4 25.3-20.5 6.5.1 4.9 2.5 6.6 5.1z" fill="#fff" />
            <path
