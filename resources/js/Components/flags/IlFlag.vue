<template>
    <svg id="flag-icons-il" viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <clipPath id="il-a">
                <path d="M-87.6 0H595v512H-87.6z" fill-opacity=".7" />
            </clipPath>
        </defs>
        <g clip-path="url(#il-a)" fill-rule="evenodd" transform="translate(82.1)scale(.94)">
