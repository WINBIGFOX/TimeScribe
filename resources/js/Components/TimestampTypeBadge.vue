            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" side="top">
                    ...
                    <DropdownMenuItem
                        ...
                        class="flex max-w-60 flex-wrap items-stretch gap-x-8 gap-y-2 bg-(--project-color)/10 not-last:mb-1 not-rtl:border-l-6 not-rtl:border-l-(--project-color) hover:bg-(--project-color)/20! rtl:border-r-6 rtl:border-r-(--project-color) dark:bg-(--project-color)/20 dark:hover:bg-(--project-color)/30!"
                        preserve-scroll
                        preserve-state
