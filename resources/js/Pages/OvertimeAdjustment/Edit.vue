...
const form = useForm({
    type: props.overtimeAdjustment.type,
    note: props.overtimeAdjustment.note,
    seconds: props.overtimeAdjustment.seconds / 3600,
    effective_date: props.overtimeAdjustment.effective_date.date
})
...
const submit = () => {
    form.transform((data) => {
        ...
        data.seconds = Math.round(data.seconds * 3600)
        return data
    }).patch(
        route('overtime-adjustment.update', {
